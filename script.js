...
function evaluate() {
    if (!previousDisplayNum || !currentDisplayNum || currentDisplayNum === ".")
        return; //prevent user from trying to press the '=' button without valid number
...
function deleteNumber() {
    if (
        (currentDisplay.textContent === "0" && currentDisplayNum === "") ||
        currentDisplayNum === result
    )
        return; //prevent user from pressing 'del' btn with this condition
